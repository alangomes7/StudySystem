...
public class GlobalExceptionHandler {
  ...
  /**
   * Handles {@link EntityNotFoundException} across the entire application. This method is triggered
   * when an {@link EntityNotFoundException} is thrown.
   *
   * @param e The {@link EntityNotFoundException} that was thrown.
   * @return a {@link ResponseEntity} with a 404 Not Found status and the exception message in the
   *     body.
   */
